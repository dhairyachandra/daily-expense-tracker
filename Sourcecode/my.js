...
$("#converted_rate").html("<strong>Exchange Rate ("+response.toConvert+"</strong>) : "+response.exhangeRate);
$("#converted_rate").show();
$("#converted_amount").html("<strong>Converted Amount ("+response.toConvert+"</strong>) : "+response.convertedAmount);
